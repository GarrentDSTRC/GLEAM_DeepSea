...
def main():
    ...
    try:
        model.learn(
            # training
            total_timesteps=args.num_envs * args.n_steps * args.total_iters * 2,    # num_steps_per_iter: args.num_envs * args.n_steps
            callback=callbacks,
